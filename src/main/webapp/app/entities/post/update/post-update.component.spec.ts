...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 27578 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 5598 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 11228 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 28808 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 8171 };
      post.blog = blog;
      const tag: ITag = { id: 15883 };
      post.tags = [tag];
